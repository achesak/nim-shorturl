# Nim module for generating Tiny URL and bit.ly-like URLs.
...
## shorturl is a Nim module for generating Tiny URL and bit.ly-like URLs.
...
type
    URLEncoder* = ref URLEncoderInternal
    URLEncoderInternal* = object
        alphabet* : string
        block_size* : int
        mask* : int
        mapping* : seq[int]
